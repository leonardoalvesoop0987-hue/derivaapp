...
export function FaqSection() {
  ...
  const faqs = [
    ...
    { q: "O Deriva é só para casal que está sem desejo?", a: "Não. O Deriva foi pensado para casais que querem viver uma experiência mais guiada, provocante e diferente. Pode funcionar muito bem quando já existe desejo — porque ele dá ritmo, surpresa e direção para a noite." },
    { q: "É muito pesado?", a: "Não precisa ser. O Deriva começa no ritmo escolhido pelo casal. Existem cartas leves, cartas mais quentes e conteúdos avançados que só aparecem se vocês liberarem." },
    { q: "E se eu tiver vergonha?", a: "A experiência foi pensada para começar sem pressão. Você não precisa performar nada. As cartas conduzem aos poucos, e vocês podem pular o que não fizer sentido." },
    { q: "O homem também aproveita?", a: "Sim. A experiência tem atenção ao ritmo dela, mas o desejo é dos dois. Ele também conduz, recebe, participa e entra no jogo." },
    ...
    { q: "O que é a categoria 'Tons mais escuros'?", a: "É um grupo avançado de cartas (envolvendo fantasias com terceiros, fetiches específicos). Esse conteúdo vem TOTALMENTE BLOQUEADO por padrão. Vocês só desbloqueiam manualmente se quiserem ir para esse caminho." },
