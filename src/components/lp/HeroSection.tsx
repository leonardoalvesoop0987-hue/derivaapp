    ...
    <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center mt-12">
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="flex flex-col items-center w-full">
          ...
          <h1 className="text-[2.5rem] md:text-5xl lg:text-[4.5rem] font-light text-white leading-[1.1] mb-8 tracking-tight">
            Uma <span className="font-[var(--font-cormorant)] italic text-[#d4a373]">noite</span> guiada para deixar o clima mais <span className="font-[var(--font-cormorant)] italic text-[#d4a373]">quente</span>.
          </h1>
          
          <p className="text-lg md:text-xl text-zinc-400 mb-12 max-w-2xl leading-relaxed font-light">
            O Deriva conduz o casal por cartas, música e escolhas inesperadas — com espaço para provocar, pular, intensificar e seguir só até onde fizer sentido para os dois.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
            ...
            >
              <span className="text-[17px] tracking-wide">Entrar no clima</span>
