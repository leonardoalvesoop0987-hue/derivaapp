...
export default function AdminVideosPage() {
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    form.append("video_category", "LESBICO");
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-light flex-1">Vídeos</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-[var(--color-text-secondary)] text-sm">
          Nenhum vídeo cadastrado. Faça upload de arquivos de vídeo.
        </div>
      ) : (
